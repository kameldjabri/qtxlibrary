...
uses 
  W3System, w3components, w3graphics, w3ToolButton,
  qtxutils,
  qtxeffects,
  qtxlabel;
...
Begin
  ...
  Begin
    ...
    Begin
      ...
      if not aValue then
      Begin
        self.fxMoveTo(mParent.width,dy,0.5,
        procedure ()
        begin
          setInheritedVisible(false);
        end);
